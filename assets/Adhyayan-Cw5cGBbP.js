import{r as a,j as e,A as o,L as l}from"./index-_jhQipeF.js";function h(){a.useEffect(()=>{const s={threshold:.1},r=new IntersectionObserver(t=>{t.forEach(i=>{i.isIntersecting&&i.target.classList.add("active")})},s);return document.querySelectorAll(".scroll-reveal").forEach(t=>r.observe(t)),()=>r.disconnect()},[]);const[c,n]=a.useState(!1);a.useEffect(()=>{const s=()=>n(window.scrollY>500);return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]);const d=()=>window.scrollTo({top:0,behavior:"smooth"});return e.jsxs("div",{className:"bg-[#050505] text-[#d1d1d1] font-sans overflow-x-hidden selection:bg-[#A855F7] selection:text-white",children:[e.jsx("style",{children:`
        :root {
            --purple: #A855F7;
            --crimson: #FF3131;
            --cyber-blue: #0EA5E9;
